...
const DEFAULT_VERSIONS = [
  ...
  {
    id: 'v3.0.0',
    name: 'Mid-Semester Deliverable',
    date: 'TBD',
    authors: 'Team Pharmacon',
    status: 'future',
    change_summary: 'Mid-semester milestone integrating doctor calibration dataset collection and trained LoRA weights on clinical cursive handwriting.',
    deployment_url: '#/roadmap',
  },
  {
    id: 'v4.0.0',
    name: 'Final Capstone Release',
    date: 'TBD',
    authors: 'Team Pharmacon',
    status: 'future',
